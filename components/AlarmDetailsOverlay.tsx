...
const AlarmDetailsOverlay: React.FC<Props> = ({ data, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black/40 flex items-center justify-center flex items-center justify-center p-4 sm:p-6">
      <div
        className="
        ...
        <div className="px-6 sm:px-10 py-8 space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="border border-gray-200 bg-white p-5 space-y-2">
              <div className="flex items-center gap-2 text-[#00646C]">
            ...
            {/* Duration */}
            <div className="border border-gray-200 bg-white p-5 space-y-2 sm:col-span-2">
              <div className="flex items-center gap-2 text-[#00646C]">
