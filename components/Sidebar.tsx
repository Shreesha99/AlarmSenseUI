      ...
      <div className="flex items-center justify-between px-4 py-4">
        ...
        {!isMobile && (
          <button
            ...
            className="p-2 rounded-md hover:bg-[#00646C]/10 transition-colors duration-200"
          >
            {effectiveCollapsed ? (
              ...
              {section.items.map((item) => {
                ...
                return (
                  <div
                    ...
                    } py-2.5 cursor-pointer transition-all duration-200 rounded-l-md
                    ${
                      isActive
                        ? "bg-[#00646C]/10 text-[#00646C] border-r-2 border-[#00646C]"
